...
type Props = {
  addToWishlist: (mediaId: string, mediaType: string) => void;
};

const WatchlistItemSpotlight = ({ addToWishlist }: Props) => {
  ...
  const onTrigger = useCallback(
    (action: SpotlightAction) => {
      addToWishlist(String(action.id), String(action.mediaType));
    },
    [addToWishlist]
  );
...
export default WatchlistItemSpotlight;
