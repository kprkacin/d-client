...
const AiringTodayTV: ForwardRefRenderFunction<unknown, DiscoverTab> = (
  props,
  ref
) => {
  const { setActiveRow } = props;
  const { data, isLoading } = api.discover.airingTodayTV.useQuery({ page: 1 });
  ...
  return (
    ...
    >
      ...
      <Title mb={12}>Airing Today TV</Title>
...
export default memo(forwardRef(AiringTodayTV));
