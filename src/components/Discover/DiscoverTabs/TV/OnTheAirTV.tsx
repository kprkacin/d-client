...
const OnTheAirTV: ForwardRefRenderFunction<unknown, DiscoverTab> = (
  props,
  ref
) => {
  const { setActiveRow } = props;
  const { data, isLoading } = api.discover.onTheAirTV.useQuery({ page: 1 });
  ...
  return (
    ...
    >
      ...
      <Title mb={12}>On The Air TV</Title>
...
export default memo(forwardRef(OnTheAirTV));
