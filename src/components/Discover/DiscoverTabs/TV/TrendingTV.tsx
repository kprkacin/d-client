...
const TrendingTV: ForwardRefRenderFunction<unknown, DiscoverTab> = (
  props,
  ref
) => {
  const { setActiveRow } = props;
  const { data, isLoading } = api.discover.trendingTV.useQuery();
...
export default memo(forwardRef(TrendingTV));
