...
const PopularPeople: ForwardRefRenderFunction<unknown, DiscoverTab> = (
  props,
  ref
) => {
  const { setActiveRow } = props;
  const { data, isLoading } = api.discover.popularPeople.useQuery({ page: 1 });
  ...
  return (
    ...
    >
      ...
      <Title mb={12}>Popular People</Title>
...
export default memo(forwardRef(PopularPeople));
