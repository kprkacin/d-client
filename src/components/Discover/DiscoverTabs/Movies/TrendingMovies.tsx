...
const TrendingMovies: ForwardRefRenderFunction<unknown, DiscoverTab> = (
  props,
  ref
) => {
  const { setActiveRow } = props;
  const { data, isLoading } = api.discover.trendingMovies.useQuery();
  ...
  return (
    ...
    >
      ...
      <Title mb={12}>TrendingMovies</Title>
...
export default memo(forwardRef(TrendingMovies));
