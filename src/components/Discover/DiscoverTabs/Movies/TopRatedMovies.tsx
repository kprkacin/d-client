...
const TopRatedMovies: ForwardRefRenderFunction<unknown, DiscoverTab> = (
  props,
  ref
) => {
  const { setActiveRow } = props;
  const { data, isLoading } = api.discover.topRatedMovies.useQuery({
    page: 1,
  });
  ...
  return (
    ...
    >
      ...
      <Title mb={12}>Top Rated Movies</Title>
...
export default memo(forwardRef(TopRatedMovies));
