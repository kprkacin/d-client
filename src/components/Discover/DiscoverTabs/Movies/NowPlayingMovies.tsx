...
const NowPlayingMovies: ForwardRefRenderFunction<unknown, DiscoverTab> = (
  props,
  ref
) => {
  const { setActiveRow } = props;
  const { data, isLoading } = api.discover.nowPlayingMovies.useQuery({
    page: 1,
  });
  ...
  return (
    ...
    >
      ...
      <Title mb={12}>Now Playing Movies</Title>
...
export default memo(forwardRef(NowPlayingMovies));
